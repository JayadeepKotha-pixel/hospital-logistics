...
import '../hospital/request_medicine.dart';
import '../hospital/view_requests.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Manage requests, track transport and stay in control.',
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => const RequestMedicine(),
                                    ),
                                  );
                                },
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => const ViewHospitalRequests(),
                                    ),
                                  );
                                },
